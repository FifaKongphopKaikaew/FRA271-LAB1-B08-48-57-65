...
## Generated on : Tue Oct 28 20:00:56 2025
...
START_DIR                 = C:/Users/User/Desktop/RMX/LABRMX~1/FRA271~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_ = -DMW_TIM1_ENCODER_VAR=mw_tim1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_FULL_LL_DRIVER -DSTM32G474xx -DUSE_HAL_DRIVER -DMW_TIMEBASESOURCE=TIM2 -DMW_CONNECTIVITY_UART=LPUART1_BASE -DMW_CONNECTIVITY_RX_DMA=DMA1 -DMW_LPUART1_RX_DMA_STREAM=1 -DMW_LPUART1_RX_DMA_ENABLED=DMA1_Channel1_IRQHandler -DMW_CONNECTIVITY_RX_DMAStream=LL_DMA_CHANNEL_1 -DMW_CONNECTIVITY_RX_BUFFER=GET_LPUART1_RECEIVE_BUFFER -DMW_LPUART1_RECEIVE_BUFFER_SIZE=1024 -DMW_LPUART1_ENABLED=1 -DMW_GPIO_BIT_SHIFT=0 -DMW_CubeMXVersion_6.15.0
...
DEFINES_STANDARD = -DMODEL=Encoder_reader_simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
DEFINES_STM32DEVICEDRIVERBLOCKS = -DMW_TIM1_ENABLED=1
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\User\Desktop\RMX\lab RMX\FRA271_Lab1_Sensors-main\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\User\Desktop\RMX\lab RMX\FRA271_Lab1_Sensors-main\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\User\Desktop\RMX\lab RMX\FRA271_Lab1_Sensors-main\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\User\Desktop\RMX\lab RMX\FRA271_Lab1_Sensors-main\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
...
stm32g4xx_ll_adc.c.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_adc.c
	$(CC) $(CFLAGS) -o "$@" "$<"
