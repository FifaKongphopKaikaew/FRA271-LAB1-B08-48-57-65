...
typedef struct {
  ...
  real_T position;                     /* '<Root>/WrapAround2' */
  real_T Homing_position;              /* '<Root>/MATLAB Function2' */
...
typedef struct {
  ...
  stm32cube_blocks_EncoderBlock_T obj_b;/* '<Root>/TIM3_Encoder2' */
  real_T last;                         /* '<Root>/WrapAround2' */
  real_T offset;                       /* '<Root>/WrapAround2' */
  real_T offset_e;                     /* '<Root>/MATLAB Function2' */
  boolean_T doneDoubleBufferReInit;    /* '<Root>/WrapAround2' */
  boolean_T last_not_empty;            /* '<Root>/WrapAround2' */
  boolean_T doneDoubleBufferReInit_b;  /* '<Root>/MATLAB Function2' */
 ...
 * '<S2>'   : 'Encoder_reader_simulink/MATLAB Function2'
 * '<S3>'   : 'Encoder_reader_simulink/WrapAround2'
